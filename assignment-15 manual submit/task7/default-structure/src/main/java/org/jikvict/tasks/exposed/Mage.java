...
/**
 * A mage character that casts spells using mana.
 * <p>
...
public class Mage extends GameCharacter {
    ...
    /** Casts a generic spell. Costs 10 mana. */
    public String castSpell() {
        if (mana < 10) return getName() + " does not have enough mana!";
        mana -= 10;
        return getName() + " casts a spell!";
    }

    /** Casts a named spell. Costs 10 mana. */
    ...
    /** Casts a named spell on a target, dealing {@code calculateDamage()} damage. Costs 10 mana. */
